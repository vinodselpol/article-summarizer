      ...
      <main className="mx-auto mt-10 flex max-w-5xl flex-1 flex-col justify-center px-2 sm:mt-40">
        <h1 className="max-w-5xl text-center text-4xl font-bold sm:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-[#3290EE]">
            <SquigglyLines />
            <span className="relative text-blue-500">TechCrunch</span>
          </span>{" "}
          article with AI
        </h1>
        <p className="mt-10 text-center text-lg text-gray-500 sm:text-2xl">
          Copy and paste any <span className="text-blue-500">TechCrunch </span>
          article link below.
        </p>
        <input
          type="text"
        ...
        {!loading && (
          <button
            type="submit"
            className="z-10 mx-auto mt-7 w-3/4 rounded-2xl border-gray-500 bg-blue-500 p-3 text-lg font-medium transition hover:bg-green-400 sm:mt-10 sm:w-1/3"
